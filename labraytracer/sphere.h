...
public:
    Sphere(const vec3& center = vec3(0, 0, 0), const double& radius = 1.0, const bool& invert = false);
...
public:
    ...
    override;
	void furtherIntersection(const Ray& ray, double maxLambda, RayIntersection& otherintersection) override;
