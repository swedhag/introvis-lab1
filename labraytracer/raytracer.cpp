...
void Raytracer::bonusTask()
{
	...
	std::shared_ptr<Sphere> sphere2 = std::make_shared<Sphere>(vec3(-1.1, 1.1, 1.1));
	std::shared_ptr<Sphere> sphere3 = std::make_shared<Sphere>(vec3(0.0, -1.1, 1.1));
	std::shared_ptr<Sphere> sphere4 = std::make_shared<Sphere>(vec3(0.0, 0.0, 2.0),1,true);
    ...
    std::shared_ptr<Sphere> sphere2 = std::make_shared<Sphere>(vec3(0.0, 0.0, 2), 1,true);
    std::shared_ptr<Sphere> sphere3 = std::make_shared<Sphere>(vec3(2.2, 0, 3), 2,true);
    std::shared_ptr<Sphere> sphere4 = std::make_shared<Sphere>(vec3(1, 1.5, 2), 1,true);
    ...
    scene_.addRenderable(sphere1);
    scene_.addMinus(sphere2);
    scene_.addMinus(sphere3);
    scene_.addMinus(sphere4);
